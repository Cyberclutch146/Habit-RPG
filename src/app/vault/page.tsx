    ...
    <>
      ...
      <main className="pt-24 pb-32 px-6 w-full flex-1 overflow-y-auto space-y-8 custom-scrollbar relative z-10">
        ...
        <section className="bg-surface-container p-6 rounded-xl shadow-xl border border-primary/20 relative overflow-hidden">
          ...
          {/* Empty state when user has no gold and hasn't earned anything yet */}
          {gold === 0 && logs.length === 0 && (
            <div className="mb-6 p-6 rounded-xl bg-amber-500/5 border border-amber-500/20 text-center">
              <div className="relative mx-auto w-16 h-16 mb-4">
                <div className="w-16 h-16 bg-amber-500/10 rounded-2xl flex items-center justify-center transform rotate-6">
                  <span className="material-symbols-outlined text-3xl text-amber-500" style={{ fontVariationSettings: "'FILL' 1" }}>savings</span>
                </div>
                <div className="absolute -bottom-1 -right-1 w-7 h-7 bg-surface-container-high rounded-lg flex items-center justify-center transform -rotate-6 border border-amber-500/20">
                  <span className="material-symbols-outlined text-sm text-amber-400">add</span>
                </div>
              </div>
              <h3 className="text-sm font-black text-on-surface uppercase tracking-tight mb-1">Your Vault is Empty</h3>
              <p className="text-[11px] text-on-surface-variant leading-relaxed max-w-sm mx-auto">
                Gold coins are earned by completing daily habits and defeating bosses. 
                Head to the <strong className="text-primary">Dashboard</strong> and start slaying quests to fill your coffers!
              </p>
            </div>
          )}
